      ...
      <div class="modal-body">
			...
			<div class="control-group mb-4">
				...
				<option selected disabled>Select Quiz</option>
					<?php
          $query = mysqli_query($conn,"SELECT * FROM quiz WHERE teacher_id = '$usrid'")or die(mysqli_error());
...
<?php } ?>
			...
			<button class="btn btn-secondary" data-dismiss="modal" aria-hidden="true">Close</button>
										...
										if (isset($_POST['saveqtc'])){
											...
											{
												mysqli_query($conn,
                        "INSERT INTO class_quiz (teacher_class_id, quiz_id, time_added) VALUES('$id[$i]','$quiz_id', NOW())");
											}
